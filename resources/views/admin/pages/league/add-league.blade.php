        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Add League</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <form action="{{route('league.create')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label class="form-label">League Name</label>
                                        <input type="text" name="league_name" class="form-control" data-provide="typeahead" id="the-basics"
                                ...
                                <div class="col-lg-12 mt-3 mt-lg-0">
                                    <div class="mb-3">
                                        <label class="form-label">League Country</label>
                                        @if(count($countries) > 0)
                                        <select name="league_country" class="selectpicker form-control" data-live-search="true">
                                            @foreach ($countries as $country)
                                            <option value="{{ $country->id }}" data-tokens="{{ $country->country_name }}">
                                                {{ $country->country_name }}</option>
                                            @endforeach
                                        </select>
                                        @else
                                        <select class="selectpicker form-control" data-live-search="true">
                                            <option data-tokens="">No Country Found</option>
                                        </select>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 mt-3 mt-lg-0 text-center">
                                    <img class="text-center" alt="" id="preview">
                                </div>
