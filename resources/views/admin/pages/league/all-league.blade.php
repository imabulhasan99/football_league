        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex justify-content-end">
                    <a href="{{ route('league.add') }}" class="btn btn-primary">Add New</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="header-title">All League List</h4>
                        
                        @if (session('league-update-success') || session('league-delete-success'))
                            <div class="alert alert-primary" role="alert">
                                @if (session('league-update-success'))
                                    <p class="text-seccess">{{ session('league-update-success') }}</p>
                                @elseif (session('league-delete-success'))
                                    <p class="text-danger">{{ session('league-delete-success') }}</p>
                                @endif
                            </div>
                        @endif
                            ...
                            <table id="example" class="table table-striped table-bordered" style="width:100%">
                                ...
                                @foreach ($leagues as $league)
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td><img src="{{asset('storage/uploads/league_flag/'.$league->league_flag)}}" alt="{{$league->league_flag}}" style="height: 100px; width:100px"></td>
                                        <td class="text-center" style="display: flex; align-items: center; justify-content: center;">
                                            <a href="{{ route('league.edit', ['id' => $league->uuid]) }}" style="margin-right: 10px;">
                                                <i class="fa-solid fa-pen-to-square fa-fade fa-2xl" style="color: #0ced27;"></i>
                                            </a>
                                        
                                            <form action="{{ route('league.delete', $league->uuid) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this league?');">
                                                @csrf
                                                @method('DELETE')
