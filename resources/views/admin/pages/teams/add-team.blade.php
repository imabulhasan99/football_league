        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    @if (session('team-success'))
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        @if ( session('team-success'))
                            <p class="text-success">{{session('team-success')}}</p>
                        @endif
                            ...
                            <form action="{{route('team.create')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{old('team_name')}}" name="team_name" class="form-control" data-provide="typeahead" id="the-basics"
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{old('founded')}}"  name="founded" class="form-control" data-provide="typeahead" id="the-basics"
