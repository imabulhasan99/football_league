                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item">All League</li>
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex justify-content-end">
                    <a href="{{ route('team.add') }}" class="btn btn-primary">Add New</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="header-title">All Team List</h4>
                        
                        @if (session('team-update-success') || session('team-delete-success'))
                            <div class="alert alert-primary" role="alert">
                                @if (session('team-update-success'))
                                    <p class="text-seccess">{{ session('team-update-success') }}</p>
                                @elseif (session('team-delete-success'))
                                    <p class="text-danger">{{ session('team-delete-success') }}</p>
                                @endif
                            </div>
                        @endif
                            ...
                            <table id="example" class="table table-striped table-bordered" style="width:100%">
                                ...
                                @foreach ($teams as $team)
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>{{$team->name}}</td>
                                        <td><img class="fa-solid fa-trash fa-fade fa-2xl" src="{{asset('storage/uploads/team_flag/'.$team->team_flag)}}" alt="{{$team->team_flag}}" style="height: 100px; width:100px"></td>
                                        <td>{{$team->founded}}</td>
                                        <td class="text-center" style="display: flex; align-items: center; justify-content: center;">
                                            <a href="{{route('team.edit',['id' => $team->id])}}" style="margin-right: 10px;">
                                                <i class="fa-solid fa-pen-to-square fa-fade fa-2xl" style="color: #0ced27;"></i>
                                            </a>
                                        
                                            <form action="{{route('team.delete',['id' => $team->id])}}" method="POST" onsubmit="return confirm('Are you sure you want to delete this league?');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" style="background: none; border: none; padding: 0; margin: 0; cursor: pointer;">
                                                    <i class="fa-solid fa-trash fa-fade fa-2xl" style="color: #f2072b;"></i>
                                                </button>
                                            </form>
                                        </td>
                      ...
                      @else 
                        <div class="empty-state text-center">
                            <div class="empty-state__content">
                              ...
                              <div class="empty-state__message"><h3>No records has been founded</h3></div>
